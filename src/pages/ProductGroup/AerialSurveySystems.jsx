...
const aerialSurveyProducts = [
  {
    id: "UnmannedAerialVehicle",
    name: "UAV",
    fullName: "Unmanned Aerial Vehicle",
    description: "A drone-based system used for high-resolution aerial mapping and remote sensing applications.",
    image: assets.UnmannedAerialVehicles,
  },
  {
    id: "AutonomousAerialVehicles",
    name: "AAV",
    fullName: "Autonomous Aerial Vehicle",
    description: "An advanced aerial system equipped with AI for automated surveying, inspection, and monitoring.",
    image: assets.AutonomousAerialVehicles,
  },
];

const AerialSurveySystemsPage = () => {
  return (
    <div className="bg-gray-50 text-gray-700 pt-20 lg:pt-24 pb-10 sm:pb-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-20">
        <Title text1="Aerial Survey" text2="Systems" />

        <p className="text-sm sm:text-base lg:text-lg text-gray-600 mt-3 sm:mt-4 max-w-3xl mx-auto text-center">
          Aerial survey systems utilize advanced drone and autonomous vehicle technology for precise mapping, surveying,
          and environmental monitoring, enhancing efficiency and accuracy in various industries.
        </p>

        <div className="grid grid-cols-1 gap-4 sm:gap-6 mt-6 sm:mt-8">
          {aerialSurveyProducts.map((product) => (
            <Link
              key={product.id}
              to={`/AerialSurveySystems/${product.id}`}
...
export default AerialSurveySystemsPage;
